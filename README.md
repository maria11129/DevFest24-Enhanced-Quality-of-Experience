...
## NOTE :
Some functions didnt work correctly because of the lack of teamwork between the backend and the frontend " Im the backend dev " but i guess you can call me " the Full stack dev ". it's sad :/ :)
